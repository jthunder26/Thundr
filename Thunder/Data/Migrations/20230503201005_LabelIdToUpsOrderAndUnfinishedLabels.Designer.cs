...
namespace Thunder.Data.Migrations
{
    ...
    [Migration("20230503201005_LabelIdToUpsOrderAndUnfinishedLabels")]
    partial class LabelIdToUpsOrderAndUnfinishedLabels
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Thunder.Data.UserBalance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UpsOrder", b =>
                {
                    b.Property<string>("LabelId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("UpsOrder", (string)null);
                });
            ...
            modelBuilder.Entity("Thunder.Data.UserBalance", b =>
                {
                    b.HasOne("Thunder.Data.ApplicationUser", "User")
                        .WithOne("UserBalance")
                        .HasForeignKey("Thunder.Data.UserBalance", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
